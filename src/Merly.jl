...
0 => [(route= "", toexec= function nf(request,HTTP); HTTP.Response(404); end , urlparams= nothing)]
...
export webserverfiles, webserverpath, notfound, headersalways, File, @page, @route, GET,POST,PUT,DELETE,HEAD,OPTIONS,PATCH,Get,Post,Put,Delete,Connect,Trace,Head,Patch,Options,start,useCORS,formats
